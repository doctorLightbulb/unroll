...
class KeyStrikes:
    ...
    def __init__(self, keystrikes):
        """
        KeyStrikes are objects containing a series of notes (or keys)
        and the time at which they are stricken.
    ...
    def find_quarter_duration(self, durations, report=False):
        ...
        If report is True, a image of the spectrum is saved.
        """
    ...
    def transcribe(
        self, filename, quarter_durations, hands_separation=60, report=False
    ):
        """
        ...
        Finally it writes everything into a native lilypond template,
        ...
        if hasattr(quarter_durations, "__iter__"):
            durations = np.arange(*quarter_durations)
