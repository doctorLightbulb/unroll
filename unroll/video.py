...
def video2rollscan(videofile, focus, start=0, end=None, savefile=None):
    ...
    Requires the python module MoviePy
    ...
    if savefile:
        ...
        plt.imsave(savefile, result)

    return result


def rollscan2keystrikes(
    roll_image,
    column_widths=[1.1, 50, 0.01],
    threshold_keypress=0.8,
    report=False,
):
    """

    Converts an image of a roll into a KeyStrikes object.
